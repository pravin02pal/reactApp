...
class SignUpForm extends Component {
  ...
  render() {
	...
	<form className="form-signin">       
	  <h2 className="form-signin-heading">{this.props.isLoggedIn ? "Add User" : "Please Register"}</h2>
	...
	<button className="btn btn-lg btn-primary btn-block" onClick={this.handleClick} type="submit">{this.props.isLoggedIn ? "Add User" : "Sign Up"}</button>
      </div>
    );
  }
}
